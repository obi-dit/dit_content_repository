...
export default function NewContentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submitData = {
        ...formData,
        // If files are selected, they should be uploaded first
        // For now, we'll use URLs if provided, or prepare files for upload
        imageFile: selectedImage,
        videoFile: selectedVideo,
      };

      // TODO: Implement actual API call
      // If files are selected, upload them first and get URLs
      // Then submit the content with imageUrl and videoUrl
      // Example:
      // if (selectedImage) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
              Add a new piece of content to your repository
            </p>
          </div>
        </div>
      </header>
